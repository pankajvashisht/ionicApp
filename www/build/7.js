...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__productdetails__ = __webpack_require__(319);
...
var ProductdetailsPage = /** @class */ (function () {
    ...
    ProductdetailsPage.prototype.send_query = function () {
        ...
        var modal = this.modalCtrl.create('SendqueryPage', {
    ...
    ProductdetailsPage.prototype.share = function () {
        var _this = this;
        this.socialSharing
            .share(this.product_details.name, this.product_details.detail, this.product_details.media[0].file, 'https://www.agrohypermarket.com/product/' + this.product_details.id)
            .then(function () {
