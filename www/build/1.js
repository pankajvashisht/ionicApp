...
var VerifiedPage = /** @class */ (function () {
    ...
    VerifiedPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-verified',template:/*ion-inline-start:"C:\xampp\htdocs\agrohyperMarket\src\pages\verified\verified.html"*/'\n<ion-content padding class="login_bg">\n    <div class="login_content">\n      <div class="check">\n          <ion-icon name="md-checkmark"></ion-icon>\n      </div>\n      <h5>Successfully!</h5>\n      <h6>verified your mobile number</h6>\n      <br>\n      <br>\n      <!-- <button ion-button class="login_btn" (click)="This.navctrl.setroot"> -->\n           <button ion-button class="login_btn" (click)="home()">\n        Take me in\n      </button> \n    </div>\n  </ion-content>\n'/*ion-inline-end:"C:\xampp\htdocs\agrohyperMarket\src\pages\verified\verified.html"*/,
        }),
